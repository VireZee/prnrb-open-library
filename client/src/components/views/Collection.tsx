...
import type { FetchQuery, RemoveMutation } from '@type/graphql/views/collection'
...
import type { CollectionProps, CollectionData } from '@type/components/views/collection'
