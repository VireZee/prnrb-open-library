...
import type { FormatterService } from '../utils/formatter/formatter.service.js'

@Injectable()
export class ValidationService {
    constructor(private readonly prismaService: PrismaService, private readonly formatterService: FormatterService) {}
